...
function initGPS() {
	...
	btn_localizar.addEventListener('click', function () {
		if (miUbicacion) {
...
function getPosition(posicion) {
	...
	view_tiempo.innerHTML = 'Tiempo de ubicaci\xF3n: ' + time;
	view_presicion.innerHTML = 'Presici\xF3n de la ubicaci\xF3n: ' + api_presicion + ' metros';
}
...
function errorPosition(error) {
	...
	console.log('El c\xF3digo de error es: ' + codigoError);
}
